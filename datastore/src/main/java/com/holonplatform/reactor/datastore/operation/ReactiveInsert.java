...
/**
 * Reactive <em>insert</em> {@link ExecutablePropertyBoxOperation} operation, using a {@link Mono} to represent and
 ...
 */
public interface ReactiveInsert extends ExecutablePropertyBoxOperation<Mono<OperationResult>, ReactiveInsert> {
