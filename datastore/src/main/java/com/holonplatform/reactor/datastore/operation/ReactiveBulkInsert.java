...
/**
 * Reactive {@link BulkInsertOperation} API, using a {@link Mono} to represent and handle the operation result.
 * 
 * @since 5.2.0
 * 
 * @see ReactiveDatastore
 */
public interface ReactiveBulkInsert extends BulkInsertOperation<Mono<OperationResult>, ReactiveBulkInsert> {
