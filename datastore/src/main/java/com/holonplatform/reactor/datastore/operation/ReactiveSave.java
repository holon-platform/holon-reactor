...
/**
 * Reactive <em>save</em> {@link ExecutablePropertyBoxOperation} operation, using a {@link Mono} to represent and handle
 ...
 */
public interface ReactiveSave extends ExecutablePropertyBoxOperation<Mono<OperationResult>, ReactiveSave> {
