 ...
 * @since 5.2.0
 */
public abstract class AbstractReactiveBulkInsert
		extends AbstractBulkInsertOperation<Mono<OperationResult>, ReactiveBulkInsert> implements ReactiveBulkInsert {
	 ...
	 */
	@Override
	protected ReactiveBulkInsert getActualOperation() {
		return this;
	}
