 ...
 * @since 5.2.0
 */
public abstract class AbstractReactiveBulkUpdate
		extends AbstractBulkUpdateOperation<Mono<OperationResult>, ReactiveBulkUpdate> implements ReactiveBulkUpdate {
	 ...
	 */
	@Override
	protected ReactiveBulkUpdate getActualOperation() {
		return this;
	}
