...
/**
 * Reactive <em>delete</em> {@link ExecutablePropertyBoxOperation} operation, using a {@link Mono} to represent and
 ...
 */
public interface ReactiveDelete
		extends ExecutablePropertyBoxOperation<Mono<OperationResult>, ReactiveDelete> {
