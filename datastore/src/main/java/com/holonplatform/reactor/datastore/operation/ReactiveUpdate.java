...
/**
 * Reactive <em>update</em> {@link ExecutablePropertyBoxOperation} operation, using a {@link Mono} to represent and
 ...
 */
public interface ReactiveUpdate extends ExecutablePropertyBoxOperation<Mono<OperationResult>, ReactiveUpdate> {
